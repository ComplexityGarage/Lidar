...
def plotter():
    ...
    axs[0].set_ylabel('Distance [m]',fontsize=16) # amplitude label
...
#pwm.start(5)
#n1 = 0
dist_array=[0]*plot_pts
servo = Servo(11)#servo at pin #11
val = -1
buzzer=Buzzer(2)#piezo buzzer at pin #2
while True:
    while val<1:
        if val>-1:
            servo.value = val
